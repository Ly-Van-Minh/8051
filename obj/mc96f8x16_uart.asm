...
;--------------------------------------------------------
	...
	.area GSFINAL (CODE)
	.area GSINIT  (CODE)
;	src/mc96f8x16_uart.c:7: volatile uint8_t RxData = 0;
	mov	_RxData,#0x00
...
;------------------------------------------------------------
;	src/mc96f8x16_uart.c:9: void UART_Config(UARTConfig_Typedef *UART_Conf)
;	-----------------------------------------
...
_UART_Config:
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/mc96f8x16_uart.c:11: UARTBD = UART_Conf->Baud;
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	lcall	__gptrget
	mov	_UARTBD,a
;	src/mc96f8x16_uart.c:12: UARTCR1 = (UARTCR1 & 0x0F) | ((UART_Conf->Parity) << 4u);
	mov	r3,_UARTCR1
	anl	ar3,#0x0f
	mov	r4,#0x00
	mov	a,#0x01
	...
	orl	ar4,a
	mov	_UARTCR1,r3
;	src/mc96f8x16_uart.c:13: UARTCR1 = (UARTCR1 & 0xF0) | ((UART_Conf->DataLength) << 1u);
	mov	r3,_UARTCR1
	anl	ar3,#0xf0
	mov	r4,#0x00
	mov	a,#0x02
	...
	orl	ar4,a
	mov	_UARTCR1,r3
;	src/mc96f8x16_uart.c:14: UARTCR3 = (UARTCR3 & 0xF4) | (UART_Conf->StopBits);
	mov	r3,_UARTCR3
	anl	ar3,#0xf4
	mov	r4,#0x00
	mov	a,#0x03
	...
	orl	ar4,a
	mov	_UARTCR3,r3
;	src/mc96f8x16_uart.c:15: UARTCR2 = (UARTCR2 & 0xD1) | (UARTCR2_RXE | UARTCR2_RXCIE | UARTCR2_TXE | UARTCR2_UARTEN);
	mov	r6,_UARTCR2
	anl	ar6,#0xd1
	orl	ar6,#0x2e
	mov	_UARTCR2,r6
;	src/mc96f8x16_uart.c:16: IE1 = (IE1 & 0xF7) | (0x08);
	mov	r6,_IE1
	anl	ar6,#0xf7
	orl	ar6,#0x08
	mov	_IE1,r6
;	src/mc96f8x16_uart.c:17: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	src/mc96f8x16_uart.c:19: HAL_Status UART_Transmit(uint8_t *Buffer, uint16_t Size, uint16_t Timeout)
;	-----------------------------------------
...
_UART_Transmit:
	...
	inc	sp
	inc	sp
;	src/mc96f8x16_uart.c:22: uint16_t StartTick = GetTick();
	lcall	_GetTick
	mov	r3,dpl
	mov	r4,dph
;	src/mc96f8x16_uart.c:23: while(Size--)
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	a
...
00134$:
	...
	ljmp	00111$
00135$:
;	src/mc96f8x16_uart.c:25: if(CheckTimeout(StartTick, Timeout) == HAL_OK)
	push	ar6
	push	ar5
	push	ar4
	push	ar3
	...
	pop	ar6
	cjne	r7,#0x01,00107$
;	src/mc96f8x16_uart.c:27: while(!(UARTST & UARTST_UDRE))
00103$:
	mov	a,_UARTST
	jb	acc.7,00105$
;	src/mc96f8x16_uart.c:29: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	push	ar4
	push	ar3
	...
	sjmp	00103$
00139$:
;	src/mc96f8x16_uart.c:31: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00112$
00105$:
;	src/mc96f8x16_uart.c:34: UARTDR = *(Buffer + i);
	push	ar5
	push	ar6
	mov	r0,_bp
	inc	r0
...
00140$:
	...
	ljmp	00109$
00107$:
;	src/mc96f8x16_uart.c:39: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00112$
00111$:
;	src/mc96f8x16_uart.c:42: return HAL_OK;
	mov	dpl,#0x01
00112$:
;	src/mc96f8x16_uart.c:43: }
	mov	sp,_bp
	pop	_bp
	ret
;------------------------------------------------------------
...
;StartTick                 Allocated to registers r3 r4 
;------------------------------------------------------------
;	src/mc96f8x16_uart.c:45: HAL_Status UART_Receive(uint8_t *Buffer, uint16_t Size, uint16_t Timeout)
;	-----------------------------------------
...
_UART_Receive:
	...
	inc	sp
	inc	sp
;	src/mc96f8x16_uart.c:48: uint16_t StartTick = GetTick();
	lcall	_GetTick
	mov	r3,dpl
	mov	r4,dph
;	src/mc96f8x16_uart.c:49: while(Size--)
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	a
...
00134$:
	...
	ljmp	00111$
00135$:
;	src/mc96f8x16_uart.c:51: if(CheckTimeout(StartTick, Timeout) == HAL_OK)
	push	ar6
	push	ar5
	push	ar4
	push	ar3
	...
	pop	ar6
	cjne	r7,#0x01,00107$
;	src/mc96f8x16_uart.c:53: while(!(UARTST & UARTST_RXC))
00103$:
	mov	a,_UARTST
	jb	acc.5,00105$
;	src/mc96f8x16_uart.c:55: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	push	ar4
	push	ar3
	...
	sjmp	00103$
00139$:
;	src/mc96f8x16_uart.c:57: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00112$
00105$:
;	src/mc96f8x16_uart.c:60: *(Buffer + i) = UARTDR;
	push	ar5
	push	ar6
	mov	r0,_bp
	inc	r0
...
00140$:
	...
	ljmp	00109$
00107$:
;	src/mc96f8x16_uart.c:65: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00112$
00111$:
;	src/mc96f8x16_uart.c:68: return HAL_OK;
	mov	dpl,#0x01
00112$:
;	src/mc96f8x16_uart.c:69: }
	mov	sp,_bp
	pop	_bp
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	src/mc96f8x16_uart.c:71: void UART_Receive_ISR(void) __interrupt 10
;	-----------------------------------------
;	 function UART_Receive_ISR
;	-----------------------------------------
_UART_Receive_ISR:
;	src/mc96f8x16_uart.c:73: RxData = UARTDR;
	mov	_RxData,_UARTDR
;	src/mc96f8x16_uart.c:74: }
	reti
