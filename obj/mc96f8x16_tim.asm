...
;--------------------------------------------------------
	...
	.area GSFINAL (CODE)
	.area GSINIT  (CODE)
;	src/mc96f8x16_tim.c:5: volatile uint16_t Tick = 0;
	clr	a
	mov	_Tick,a
	mov	(_Tick + 1),a
...
;------------------------------------------------------------
;	src/mc96f8x16_tim.c:7: void SysTick_Init(void)
;	-----------------------------------------
...
_SysTick_Init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/mc96f8x16_tim.c:9: BITCR = 0x00;
	mov	_BITCR,#0x00
;	src/mc96f8x16_tim.c:10: BITCR |= (BITCK_FX_DIV_1024 << 5u) | ((BCK_BIT2_OVFL << 0u) | BITCR_BCLR);
	orl	_BITCR,#0x2a
;	src/mc96f8x16_tim.c:11: IE3 = (IE3 & 0x0F) | (0x10);
	mov	r6,_IE3
	anl	ar6,#0x0f
	orl	ar6,#0x10
	mov	_IE3,r6
;	src/mc96f8x16_tim.c:12: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'GetTick'
;------------------------------------------------------------
;	src/mc96f8x16_tim.c:14: uint16_t GetTick(void)
;	-----------------------------------------
;	 function GetTick
;	-----------------------------------------
_GetTick:
;	src/mc96f8x16_tim.c:16: return Tick;
	mov	dpl,_Tick
	mov	dph,(_Tick + 1)
;	src/mc96f8x16_tim.c:17: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'SysTick_ISR'
;------------------------------------------------------------
;	src/mc96f8x16_tim.c:19: void SysTick_ISR(void) __interrupt 23
;	-----------------------------------------
...
;	src/mc96f8x16_tim.c:21: Tick++;
	...
	addc	a,(_Tick + 1)
	mov	(_Tick + 1),a
;	src/mc96f8x16_tim.c:23: BITCR |= BITCR_BCLR;
	orl	_BITCR,#0x08
;	src/mc96f8x16_tim.c:24: }
	pop	psw
	pop	acc
	reti
...
;------------------------------------------------------------
;	src/mc96f8x16_tim.c:26: void Delayms(uint16_t Timeout)
;	-----------------------------------------
;	 function Delayms
;	-----------------------------------------
_Delayms:
	...
	mov	r6,dpl
	mov	r7,dph
;	src/mc96f8x16_tim.c:28: uint16_t StartTick = GetTick();
	push	ar7
	push	ar6
	lcall	_GetTick
	mov	r4,dpl
	...
	pop	ar6
	pop	ar7
;	src/mc96f8x16_tim.c:29: if(StartTick + Timeout > StartTick)
	mov	a,r6
	add	a,r4
	mov	r2,a
	mov	a,r7
	...
	subb	a,r3
	jnc	00115$
;	src/mc96f8x16_tim.c:31: while(GetTick() < StartTick + Timeout);
	mov	r0,_bp
	inc	r0
	mov	a,r6
	add	a,r4
...
00101$:
	...
	subb	a,@r0
	jnc	00111$
;	src/mc96f8x16_tim.c:35: while((GetTick() < (Timeout - (0xFFFFU - StartTick))) || (GetTick() > StartTick));
	sjmp	00101$
00115$:
	mov	a,#0xff
	clr	c
...
;------------------------------------------------------------
;	src/mc96f8x16_tim.c:39: HAL_Status CheckTimeout(uint16_t Start, uint16_t Timeout)
;	-----------------------------------------
...
_CheckTimeout:
	...
	push	dpl
	push	dph
;	src/mc96f8x16_tim.c:42: if(Start + Timeout > Start)
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0xfc
	...
	subb	a,r5
	jnc	00109$
;	src/mc96f8x16_tim.c:44: if(GetTick() < (Start + Timeout))
	lcall	_GetTick
	mov	r4,dpl
	mov	r5,dph
	mov	r0,_bp
	...
	subb	a,r3
	jnc	00102$
;	src/mc96f8x16_tim.c:46: ret = HAL_OK;
	mov	r5,#0x01
	sjmp	00110$
00102$:
;	src/mc96f8x16_tim.c:50: ret = HAL_TIMEOUT;
	mov	r5,#0x02
	sjmp	00110$
00109$:
;	src/mc96f8x16_tim.c:55: if((GetTick() < (Timeout - (0xFFFFU - Start))) || (GetTick() > Start))
	lcall	_GetTick
	mov	r3,dpl
	mov	r4,dph
	mov	r0,_bp
	...
	jnc	00105$
00104$:
;	src/mc96f8x16_tim.c:57: ret = HAL_OK;
	mov	r5,#0x01
	sjmp	00110$
00105$:
;	src/mc96f8x16_tim.c:61: ret = HAL_TIMEOUT;
	mov	r5,#0x02
00110$:
;	src/mc96f8x16_tim.c:64: return ret;
	mov	dpl,r5
;	src/mc96f8x16_tim.c:65: }
	mov	sp,_bp
	pop	_bp
	ret
	.area CSEG    (CODE)
