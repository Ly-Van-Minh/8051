...
;------------------------------------------------------------
;	src/mc96f8x16_i2c.c:8: void I2C_Config(I2C_Config_Typedef *I2C_Conf)
;	-----------------------------------------
;	 function I2C_Config
;	-----------------------------------------
_I2C_Config:
	...
	mov	r6,dph
	mov	r7,b
;	src/mc96f8x16_i2c.c:10: I2CCR = (I2CCR & ~I2CCR_IMASTER) | ((I2C_Conf->Mode) << 2u);
	mov	a,#0xfb
	anl	a,_I2CCR
	mov	r4,a
	mov	dpl,r5
	...
	orl	a,r4
	mov	_I2CCR,a
;	src/mc96f8x16_i2c.c:11: I2CSDHR = I2C_Conf->HoldTime;
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
	...
	lcall	__gptrget
	mov	_I2CSDHR,a
;	src/mc96f8x16_i2c.c:12: I2CSCLR = (uint8_t)(I2C_Conf->Period);
	mov	a,#0x02
	add	a,r5
	mov	r5,a
	clr	a
	...
	lcall	__gptrget
	mov	_I2CSCLR,a
;	src/mc96f8x16_i2c.c:13: I2CSCHR = (uint8_t)((I2C_Conf->Period) >> 8u);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	...
	mov	r6,a
	mov	_I2CSCHR,r6
;	src/mc96f8x16_i2c.c:14: I2CCR |= (I2CCR_ACKEN | I2CCR_IICEN);
	orl	_I2CCR,#0x48
;	src/mc96f8x16_i2c.c:15: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	src/mc96f8x16_i2c.c:17: HAL_Status I2C_Master_Transmit(uint8_t DevAddr, uint8_t RegAddr, uint8_t Data,  uint16_t Timeout)
;	-----------------------------------------
...
_I2C_Master_Transmit:
	...
	mov	_bp,sp
	mov	r7,dpl
;	src/mc96f8x16_i2c.c:19: uint16_t StartTick = GetTick();
	push	ar7
	lcall	_GetTick
	mov	r5,dpl
	mov	r6,dph
	pop	ar7
;	src/mc96f8x16_i2c.c:20: I2CDR = (DevAddr << 1u);
	mov	a,r7
	add	a,r7
	mov	_I2CDR,a
;	src/mc96f8x16_i2c.c:21: while ((I2CSR & I2CSR_BUSY))
00103$:
	mov	a,_I2CSR
	jnb	acc.2,00105$
;	src/mc96f8x16_i2c.c:23: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xfa
	...
	sjmp	00103$
00179$:
;	src/mc96f8x16_i2c.c:25: return HAL_TIMEOUT;
	mov	dpl,#0x02
	ljmp	00124$
00105$:
;	src/mc96f8x16_i2c.c:28: I2CCR |= I2CCR_STARTC;  /* Start transmit */
	orl	_I2CCR,#0x01
;	src/mc96f8x16_i2c.c:29: while(!(I2CSR & I2CSR_RXACK))
00108$:
	mov	a,_I2CSR
	jb	acc.0,00110$
;	src/mc96f8x16_i2c.c:31: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xfa
	...
	sjmp	00108$
00181$:
;	src/mc96f8x16_i2c.c:33: return HAL_TIMEOUT;
	mov	dpl,#0x02
	ljmp	00124$
00110$:
;	src/mc96f8x16_i2c.c:36: if(!(I2CSR & I2CSR_MLOST))  /* Check I2C maintains bus mastership */
	mov	a,_I2CSR
	jb	acc.3,00122$
;	src/mc96f8x16_i2c.c:38: I2CDR = RegAddr;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	_I2CDR,@r0
;	src/mc96f8x16_i2c.c:39: while(!(I2CSR & I2CSR_RXACK))
00113$:
	mov	a,_I2CSR
	jb	acc.0,00115$
;	src/mc96f8x16_i2c.c:41: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xfa
	...
	sjmp	00113$
00184$:
;	src/mc96f8x16_i2c.c:43: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00124$
00115$:
;	src/mc96f8x16_i2c.c:46: I2CDR = Data;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	_I2CDR,@r0
;	src/mc96f8x16_i2c.c:47: while(!(I2CSR & I2CSR_RXACK))
00118$:
	mov	a,_I2CSR
	jb	acc.0,00123$
;	src/mc96f8x16_i2c.c:49: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xfa
	...
	sjmp	00118$
00186$:
;	src/mc96f8x16_i2c.c:51: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00124$
00122$:
;	src/mc96f8x16_i2c.c:57: return HAL_BUSY;
	mov	dpl,#0x04
	sjmp	00124$
00123$:
;	src/mc96f8x16_i2c.c:59: I2CCR |= I2CCR_STOPC;   /* Stop transmit */
	orl	_I2CCR,#0x02
;	src/mc96f8x16_i2c.c:60: I2CSR &= ~(I2CSR_GCALL | I2CSR_TEND | I2CSR_STOPD | I2CSR_SSEL | I2CSR_MLOST);  /* Clear interrupt bits */  
	anl	_I2CSR,#0x07
;	src/mc96f8x16_i2c.c:61: return HAL_OK;
	mov	dpl,#0x01
00124$:
;	src/mc96f8x16_i2c.c:62: }
	pop	_bp
	ret
;------------------------------------------------------------
...
;StartTick                 Allocated to registers r5 r6 
;------------------------------------------------------------
;	src/mc96f8x16_i2c.c:64: HAL_Status I2C_Master_Receive(uint8_t DevAddr, uint8_t RegAddr, uint8_t *pData, uint16_t Timeout)
;	-----------------------------------------
...
_I2C_Master_Receive:
	...
	mov	_bp,sp
	mov	r7,dpl
;	src/mc96f8x16_i2c.c:66: uint16_t StartTick = GetTick();
	push	ar7
	lcall	_GetTick
	mov	r5,dpl
	mov	r6,dph
	pop	ar7
;	src/mc96f8x16_i2c.c:67: I2CDR = (DevAddr << 1u) | 0x01;
	mov	a,r7
	add	a,r7
	mov	r7,a
	mov	r4,#0x00
	orl	ar7,#0x01
	mov	_I2CDR,r7
;	src/mc96f8x16_i2c.c:68: while ((I2CSR & I2CSR_BUSY))
00103$:
	mov	a,_I2CSR
	jnb	acc.2,00105$
;	src/mc96f8x16_i2c.c:70: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xf8
	...
	sjmp	00103$
00179$:
;	src/mc96f8x16_i2c.c:72: return HAL_TIMEOUT;
	mov	dpl,#0x02
	ljmp	00124$
00105$:
;	src/mc96f8x16_i2c.c:75: I2CCR |= I2CCR_STARTC;  /* Start transmit */
	orl	_I2CCR,#0x01
;	src/mc96f8x16_i2c.c:76: while(!(I2CSR & I2CSR_RXACK))
00108$:
	mov	a,_I2CSR
	jb	acc.0,00110$
;	src/mc96f8x16_i2c.c:78: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xf8
	...
	sjmp	00108$
00181$:
;	src/mc96f8x16_i2c.c:80: return HAL_TIMEOUT;
	mov	dpl,#0x02
	ljmp	00124$
00110$:
;	src/mc96f8x16_i2c.c:83: if(!(I2CSR & I2CSR_MLOST))  /* Check I2C maintains bus mastership */
	mov	a,_I2CSR
	jnb	acc.3,00182$
	ljmp	00122$
00182$:
;	src/mc96f8x16_i2c.c:85: I2CDR = RegAddr;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	_I2CDR,@r0
;	src/mc96f8x16_i2c.c:86: while(!(I2CSR & I2CSR_RXACK))
00113$:
	mov	a,_I2CSR
	jb	acc.0,00118$
;	src/mc96f8x16_i2c.c:88: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xf8
	...
	sjmp	00113$
00184$:
;	src/mc96f8x16_i2c.c:90: return HAL_TIMEOUT;
	mov	dpl,#0x02
;	src/mc96f8x16_i2c.c:93: while(!(I2CSR & I2CSR_TEND))
	sjmp	00124$
00118$:
	mov	a,_I2CSR
	jb	acc.6,00120$
;	src/mc96f8x16_i2c.c:95: if(CheckTimeout(StartTick, Timeout) != HAL_OK)
	push	ar6
	push	ar5
	mov	a,_bp
	add	a,#0xf8
	...
	sjmp	00118$
00186$:
;	src/mc96f8x16_i2c.c:97: return HAL_TIMEOUT;
	mov	dpl,#0x02
	sjmp	00124$
00120$:
;	src/mc96f8x16_i2c.c:100: *pData = I2CDR;
	mov	a,_bp
	add	a,#0xfa
	mov	r0,a
	mov	ar5,@r0
	...
	sjmp	00123$
00122$:
;	src/mc96f8x16_i2c.c:104: return HAL_BUSY;
	mov	dpl,#0x04
	sjmp	00124$
00123$:
;	src/mc96f8x16_i2c.c:106: I2CCR |= I2CCR_STOPC;   /* Stop transmit */
	orl	_I2CCR,#0x02
;	src/mc96f8x16_i2c.c:107: I2CSR &= ~(I2CSR_GCALL | I2CSR_TEND | I2CSR_STOPD | I2CSR_SSEL | I2CSR_MLOST);  /* Clear interrupt bits */  
	anl	_I2CSR,#0x07
;	src/mc96f8x16_i2c.c:108: return HAL_OK;
	mov	dpl,#0x01
00124$:
;	src/mc96f8x16_i2c.c:109: }
	pop	_bp
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
