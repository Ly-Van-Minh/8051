...
;------------------------------------------------------------
;	src/mc96f8x16_cg.c:8: void SysClock_Config(void)
;	-----------------------------------------
...
_SysClock_Config:
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/mc96f8x16_cg.c:10: OSCCR = (FIRC_8MHZ << 3U); /* Select INT-RC/2 (8MHz) */
	mov	_OSCCR,#0x20
;	src/mc96f8x16_cg.c:11: SCCR = SYS_CLK_SEL_FIRC;    /* Select f(IRC) for system clock */
	mov	_SCCR,#0x00
;	src/mc96f8x16_cg.c:12: nop();
	nop 
;	src/mc96f8x16_cg.c:13: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
