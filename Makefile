...
LDFLAGS			= --xram-loc 0x00 --code-loc 0x00 --stack-loc 0xB0 --xstack-loc 0x0100 --data-loc 0x00 --idata-loc 0x80 -Wl -bBSEG=0x20 --iram-size 0x100 --xram-size 0x200 --code-size 0x4000 --stack-size 0x40
RM 				= rm -rf
